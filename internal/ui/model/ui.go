...
import (
	...
	"github.com/Omerfaruk-aydn/Atlas-Agent/internal/ui/completions"
...
func (m *UI) openAuthenticationDialog(provider catwalk.Provider, model config.SelectedModel, modelType config.SelectedModelType) tea.Cmd {
	...
	case catwalk.InferenceProviderChatGPT:
	...
	case catwalk.InferenceProviderMuse:
		dlg, cmd = dialog.NewOAuthMuse(m.com, isOnboarding, provider, model, modelType)
	default:
