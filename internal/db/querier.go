...
type Querier interface {
	...
	ListSessionsByParent(ctx context.Context, parentSessionID sql.NullString) ([]Session, error)
	ListUserMessagesBySession(ctx context.Context, sessionID string) ([]Message, error)
	RecordFileRead(ctx context.Context, arg RecordFileReadParams) error
	RenameSession(ctx context.Context, arg RenameSessionParams) error
	SetSessionGoal(ctx context.Context, arg SetSessionGoalParams) error
	SetSessionTags(ctx context.Context, arg SetSessionTagsParams) error
