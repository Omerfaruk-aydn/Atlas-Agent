...
func quickStyle(o quickStyleOpts) Styles {
	...
	s.Editor.PromptPlanIconFocused = lipgloss.NewStyle().MarginRight(1).Foreground(o.onPrimary).Background(o.info).Bold(true).SetString(" P ")
	...
	s.Editor.PromptAutoAcceptIconFocused = lipgloss.NewStyle().MarginRight(1).Foreground(o.onPrimary).Background(o.success).Bold(true).SetString(" A ")
	s.Editor.PromptAutoAcceptIconBlurred = s.Editor.PromptAutoAcceptIconFocused.Foreground(o.bgBase).Background(o.fgMoreSubtle)
	s.Editor.PromptAutoAcceptDotsFocused = lipgloss.NewStyle().MarginRight(1).Foreground(o.success).SetString(":::")
	s.Editor.PromptAutoAcceptDotsBlurred = s.Editor.PromptAutoAcceptDotsFocused.Foreground(o.fgMoreSubtle)
